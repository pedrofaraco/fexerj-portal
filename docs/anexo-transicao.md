...
| `FirstTrn_` | programa | `1` depois do primeiro torneio **aceito** — aquele em que o jogador pontuou contra adversário com rating. Enquanto está em `0`, o próximo torneio zerado é descartado (seção 6.1 do Anexo Normativo). Volta a `0` se o piso derrubar o jogador (seção 7 do Anexo Normativo). |
